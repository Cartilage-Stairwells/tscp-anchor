...
pub trait DeepAliVerifier<F: Field, S: p3_commit::Mmcs<F>, C: CanObserve<F> + CanSample<F>>
...
impl<MMCS, P> DeepAliVerifier<BabyBear, MMCS, DeepAliChallenger<P>> for BabyBearDeepAli<MMCS, P>
...

{
    ...
    fn verify_deep_batch(
        ...
        trace_commitment: &MMCS::Commitment,
